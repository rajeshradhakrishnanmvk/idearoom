...
- When using repository context to inform the spec, scope it to `skills/` and `scripts/`, and ignore `docs/` and `k8s/` unless the user explicitly asks to include them.
